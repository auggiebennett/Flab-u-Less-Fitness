...
(1, 'John Doe', 'johndoe@example.com', '123-456-7890', '2022-01-01', 'Active', 'Credit Card', 'Email'),
(2, 'Jane Smith', 'janesmith@example.com', '098-765-4321', '2022-06-15', 'Inactive', 'PayPal', 'SMS'),
(3, 'Emily Clark', 'emilyclark@example.com', '321-654-9870', '2022-02-01', 'Active', 'Debit Card', 'Email'),
(4, 'Michael Brown', 'michaelbrown@example.com', '654-321-0987', '2022-03-01', 'Active', 'Bank Transfer', 'Phone'),
(5, 'Olivia Green', 'oliviagreen@example.com', '987-654-3210', '2022-04-01', 'Inactive', 'Cash', 'SMS');
